...
const BUILDING_DEFS = {
    hydro_trap: {
        bid: "hydro_trap", type: "trap", name: "挂水装置",
        element: "water", cost: 100, icon: "💧", color: "#4488cc",
        cooldown: 2.0, description: "放在怪物路径上，经过时附着水元素",
    },
    crossbow: {
        bid: "crossbow", type: "tower", name: "弩塔",
        element: "fire", cost: 200, range: 2.5, atk_speed: 2.0,
        damage: 60, icon: "🏹", color: "#cc4444",
...
const TD_ENEMY_STATS = {
    hilichurl:       { name: "丘丘人", hp: 150, speed: 1.2, gold: 30,  element: null, color: "#888" },
    hilichurl_fighter:{ name: "丘丘人战士", hp: 400, speed: 1.0, gold: 60, element: null, color: "#a66" },
    slime_fire:      { name: "火史莱姆", hp: 250, speed: 0.9, gold: 45, element: "fire", color: "#e44" },
    slime_water:     { name: "水史莱姆", hp: 280, speed: 1.0, gold: 45, element: "water", color: "#38b" },
    abyss_mage:      { name: "深渊法师", hp: 900, speed: 0.7, gold: 120, element: null, color: "#66c" },
    ruin_guard:      { name: "遗迹守卫", hp: 3000, speed: 0.4, gold: 300, element: null, color: "#aaa" },
};
